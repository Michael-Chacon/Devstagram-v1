<div>
    <form wire:submit.prevent='registrarComentario'>
        ...
        <div class="mb-5">
            ...
            <textarea type="text" id="comentario" wire:model="comentario" placeholder="Add Comment" class="border p-3 w-full rounded-lg @error('descripcion') border-red-500 @enderror"></textarea>
            @error('comentario')
